...
|-----------|--------------|--------|
| capture | `src/finger_tracker/capture/**` | config |
| training | `src/finger_tracker/training/**` `data/**` | config, capture |
| detection | `src/finger_tracker/detection/**` | config |
| config | `src/finger_tracker/config/**` | — |
| scripts | `scripts/**` | capture, detection |
| docs | `docs/**` `CLAUDE.md` | capture, training, detection, config |
